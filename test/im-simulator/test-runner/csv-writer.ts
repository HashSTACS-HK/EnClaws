...
export class CsvWriter {
  ...
  /**
   * Merge multiple CSV files into one final CSV.
   * Each source file should have been written by a CsvWriter (with BOM + header).
   * The merged file has one header row followed by all data rows.
   */
