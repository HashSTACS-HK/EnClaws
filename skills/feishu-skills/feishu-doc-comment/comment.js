 ...
 *   node comment.js --open-id ou_xxx --action list --file-token TOKEN --file-type wiki
 *   node comment.js --open-id ou_xxx --action list --file-token TOKEN --file-type docx --is-solved false --is-whole true
 *   node comment.js --open-id ou_xxx --action create --file-token TOKEN --file-type docx --content "评论内容"
 *   node comment.js --open-id ou_xxx --action patch --file-token TOKEN --file-type docx --comment-id COMMENT_ID --is-solved true
 *
