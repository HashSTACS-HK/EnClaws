...
export const dingtalkPlugin: ChannelPlugin<ResolvedDingtalkAccount> = {
  ...
  security: {
    collectWarnings: ({ cfg, accountId }) => {
      ...
      return [
        `- DingTalk[${account.accountId}] groups: groupPolicy="open" allows any member to trigger (mention-gated). Set channels.dingtalk.groupPolicy="allowlist" + channels.dingtalk.groupAllowFrom to restrict senders.`,
      ];
    },
  },
  setup: {
