...
export const de: TranslationMap = {
  ...
  nav: {
    ...
    changePasswordTitle: "Passwort aendern",
  },
  tabs: {
    agents: "Agenten",
    overview: "Startseite",
  ...
  cs: {
    ...
    widget: {
      ...
      sectionHint:
        "Jedes Widget ist ein eigenstaendiger Einbettungskanal. Konfigurieren Sie Name, zugeordneten KI-Mitarbeiter und Status und kopieren Sie dann den Einbettungscode auf Ihre Seite.",
      widgetN: "Widget {n}",
      labelPlaceholder: "Widget-Namen eingeben (keine Leerzeichen)",
      agentLabel: "KI-Mitarbeiter",
      agentDefault: "- Standard (nicht angegeben) -",
      statusLabel: "Status",
      statusEnabled: "Aktiviert",
      statusDisabled: "Deaktiviert",
      statusEnableHint: "Klicken, um dieses Widget zu aktivieren",
      statusDisableHint: "Klicken, um dieses Widget zu deaktivieren",
      createBtn: "Widget erstellen",
      saveBtn: "Speichern",
      editBtn: "Bearbeiten",
      cancelBtn: "Abbrechen",
      deleteBtn: "Loeschen",
      ...
      copied: "Kopiert",
      expandCode: "Code anzeigen",
      collapseCode: "Code ausblenden",
      addBtn: "+ Widget hinzufuegen (bis zu {max})",
      capReached: "Maximum von {max} Widgets erreicht.",
      errLabelEmpty: "Der Widget-Name darf nicht leer sein",
      errLabelSpace: "Der Widget-Name darf keine Leerzeichen enthalten",
      errLabelDup: "Der Widget-Name existiert bereits, bitte verwenden Sie einen eindeutigen Namen",
      saveError: "Widget konnte nicht gespeichert werden",
      noTenant: "Kein Mandantenkontext verfuegbar",
    },
    apiMode: {
      title: "API-Modus",
      ...
      create: {
        ...
        agentLabel: "Agent",
        agentNone: "— Kein Agent (Standard verwenden) —",
        submitBtn: "Erstellen",
