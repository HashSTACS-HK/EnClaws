...
export const pt_BR: TranslationMap = {
  ...
  cs: {
    ...
    widget: {
      ...
      sectionHint:
        "Cada widget é um canal de incorporação independente. Configure o nome, o funcionário de IA vinculado e o status, depois copie o código de incorporação para a sua página.",
      widgetN: "Widget {n}",
      labelPlaceholder: "Digite o nome do widget (sem espaços)",
      agentLabel: "Funcionário de IA",
      agentDefault: "— Padrão (não especificado) —",
      statusLabel: "Status",
      statusEnabled: "Ativado",
      statusDisabled: "Desativado",
      statusEnableHint: "Clique para ativar este widget",
      statusDisableHint: "Clique para desativar este widget",
      createBtn: "Criar Widget",
      saveBtn: "Salvar",
      editBtn: "Editar",
      cancelBtn: "Cancelar",
      deleteBtn: "Excluir",
      ...
      copied: "Copiado",
      expandCode: "Mostrar Código",
      collapseCode: "Ocultar Código",
      addBtn: "+ Adicionar Widget (até {max})",
      capReached: "Máximo de {max} widgets atingido.",
      errLabelEmpty: "O nome do widget não pode estar vazio",
      errLabelSpace: "O nome do widget não pode conter espaços",
      errLabelDup: "O nome do widget já existe, use um nome único",
      saveError: "Falha ao salvar o widget",
      noTenant: "Nenhum contexto de inquilino disponível",
    },
    apiMode: {
      title: "Modo API",
      ...
      create: {
        ...
        agentLabel: "Agente",
        agentNone: "— Sem agente (usar padrão) —",
        submitBtn: "Criar",
        submitting: "Criando…",
        cancelBtn: "Cancelar",
