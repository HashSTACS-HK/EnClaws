...
import { resolveRequestStorePath } from "../../gateway/tenant-session-utils.js";
...
export async function initSessionState(params: {
  ...
  const storePath = ctx.TenantId
    ? resolveRequestStorePath(cfg, agentId, ctx.TenantId, ctx.TenantUserId)
