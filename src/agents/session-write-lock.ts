...
const CLEANUP_STATE_KEY = Symbol.for("enclaws.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("enclaws.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("enclaws.sessionWriteLockWatchdogState");
